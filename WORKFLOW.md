...
### Step 1: Open Your Working Branch
...
2. Commit and push to `drafts-website-edits`.

---

## Previewing Your Changes (Netlify)

Changes pushed to `drafts-website-edits` are automatically deployed to the preview URL. No extra steps needed.
...
- Always work on `drafts-website-edits` (never edit `main` directly)
...
| Task | Where to Do It |
|------|----------------|
| Edit content | GitHub.com → `drafts-website-edits` branch |
| Preview in Netlify | Automatic — just push to `drafts-website-edits` |
